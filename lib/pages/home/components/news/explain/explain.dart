...
import 'package:clone_empiricus_research/pages/home/components/news/explain/explain_list_view.dart';
...
class Explain extends StatefulWidget {
  final List<NewsModel> explainNews;
  const Explain({
    super.key,
    required this.explainNews,
  });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ExplainListView(listNews: widget.explainNews)
              ],
            ),
          ),
        );

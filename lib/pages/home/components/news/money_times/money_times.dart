...
import 'package:clone_empiricus_research/pages/home/components/news/money_times/money_times_list_view.dart';
...
class MoneyTimes extends StatefulWidget {
  final List<NewsModel> moneyTimesNews;
  const MoneyTimes({
    super.key,
    required this.moneyTimesNews,
  });

  @override
  State<MoneyTimes> createState() => _MoneyTimesState();
}

class _MoneyTimesState extends State<MoneyTimes> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                MoneyTimesListView(listNews: widget.moneyTimesNews)
              ],
            ),
          ),
        );
